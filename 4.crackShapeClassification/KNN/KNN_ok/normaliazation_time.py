...
data = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/test-time.txt", delimiter=",")
...
resdata = np.column_stack((resdata, data[:, 13]))
print(resdata.shape)

np.savetxt("/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/normaliazation/test-time-nor.txt", resdata, delimiter=",")
