...
for i in range(m):
    ...
    y1 = np.loadtxt(f"/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/test2/{fileNameStr}")
    print(np.max(y1))
    print(y1.shape)
    # print(max(y1))
    ...
    with open("/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/train10/test.txt", 'a+') as f:
