...
data_train = np.loadtxt("/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train4/train4.txt", delimiter=",")
data_test = np.loadtxt("/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/test4/test4.txt", delimiter=",")
...
x_train, y_train = np.split(data_train,  # 要切分的数组
                            (23,),  # 沿轴切分的位置，第7列开始往后为y
                            axis=1)  # 1代表纵向分割，按列分割

x_train = x_train[:, 0:23]
