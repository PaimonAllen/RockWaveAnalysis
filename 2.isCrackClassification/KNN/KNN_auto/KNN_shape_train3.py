...
def KNNclassify():
    ...
    trainingFileList = listdir(
        '/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/train3/')
    ...
    for i in range(m):
        ...
        trainingMat[i, :] = vector(
            '/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/train3/%s' % (fileNameStr))
        # print(i)
    ...
    testFileList = listdir(
        '/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/test3/')
    # 错误检测计数
    errorCount = 0.0
    # 测试数据的数量
    ...
    for i in range(mTest):
        ...
        vectorUnderTest = vector(
            '/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/test3/%s' % (fileNameStr))
        # 获得预测结果
        ...
        # 加入混淆矩阵
        confusionMat[classNumber-1][classifierResult-1] += 1
    ...
    np.savetxt("./log/train3-conMat.txt", confusionMat)
