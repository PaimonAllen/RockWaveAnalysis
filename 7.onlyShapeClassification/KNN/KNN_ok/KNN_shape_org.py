...
def KNNclassify():
    ...
    trainingFileList = listdir('/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train1/')
    ...
    for i in range(m):
        ...
        trainingMat[i, :] = vector(
            '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train1/%s' % (fileNameStr))
        # print(i)
    ...
    testFileList = listdir('/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/test1/')
    # 错误检测计数
    errorCount = 0.0
    # 测试数据的数量
    ...
    for i in range(mTest):
        ...
        vectorUnderTest = vector(
            '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/test1/%s' % (fileNameStr))
        # 获得预测结果
