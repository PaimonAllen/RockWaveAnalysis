...
if __name__ == '__main__':
    ...
    data = pd.read_csv(
        '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train3-CNN/train7-All.csv')
    data = process_data(data)
    test_data = pd.read_csv(
        '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train3-CNN/test3.csv')
