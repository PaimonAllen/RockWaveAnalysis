...
data_train = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/normaliazation/train-time-nor.txt", delimiter=",")
data_test = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/normaliazation/test-time-nor.txt", delimiter=",")
