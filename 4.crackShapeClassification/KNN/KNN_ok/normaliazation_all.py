...
data = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/test-all.txt", delimiter=",")
...
resdata = np.column_stack((resdata, data[:, 17]))
print(resdata.shape)

np.savetxt("/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/normaliazation/test-all-nor.txt", resdata, delimiter=",")
