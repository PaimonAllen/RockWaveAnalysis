...
train = pd.read_csv('/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train3-CNN/train3-All.csv')
testA = pd.read_csv('/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train3-CNN/test3.csv')
