...
data_train = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/train5/train5.txt", delimiter=",")
data_test = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/test5/test5.txt", delimiter=",")
