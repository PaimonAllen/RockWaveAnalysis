...
train_data = np.loadtxt("/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/train10/train10.txt", delimiter=",")
test_data = np.loadtxt("/home/tzr/DataLinux-SSD/Dataset/2.isCrackClassification/KNN/dataset/train10/test10.txt", delimiter=",")
...
def SVMclassify():
    ...
    for i in range(0, m):
        ...
        classifierResult = clf.predict(x_test_cur)
