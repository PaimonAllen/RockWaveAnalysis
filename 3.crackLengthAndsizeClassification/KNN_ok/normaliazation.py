...
data = np.loadtxt(
    "/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/train10/train.txt", delimiter=",")
...
np.savetxt("/home/tzr/DataLinux-SSD/Dataset/6.crackLengthAndShapeClassification/KNN/dataset/train10/train-nor.txt", resdata, delimiter=",")
