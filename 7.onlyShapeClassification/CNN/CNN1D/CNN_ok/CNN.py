...
def valid_loop(dataloader, model, loss_fn):
    ...
    correct /= size
    print(
        f"Test Results:\nAccuracy: {(100*correct):>0.3f}% abs-sum loss: {l1_loss:>8f} CroEtr loss: {test_loss:>8f}")
...
if __name__ == '__main__':
    ...
    data = pd.read_csv(
        '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train3-CNN/train8-All.csv')
    data = process_data(data)
    test_data = pd.read_csv(
        '/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/CNN/dataset/train9-NN/test9.csv')
