...
FileList = listdir('/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/test11/')
# 返回文件夹下文件的个数
m = len(FileList)
# print(FileList)
print(m)
for i in range(m):
    ...
    y1 = np.loadtxt(f"/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/test11/{fileNameStr}")
    print(np.max(y1))
    print(y1.shape)
    # print(max(y1))
    ...
    # sys.exit()
    with open("/home/tzr/DataLinux-SSD/Dataset/7.onlyShapeClassification/KNN/dataset/train12/test-all.txt", 'a+') as f:
